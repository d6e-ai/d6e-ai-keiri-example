...
- External: [`d6e-saas-google-workspace`](https://github.com/d6e-ai/d6e/blob/main/packages/skills/d6e-saas-google-workspace/SKILL.md) — Lives in the `d6e` repo and documents the `drive_files` SQL projection plus the `d6e_read_drive_file` MCP tool that any Drive-mirror scenario in this skill ultimately consumes.
- Background: [Custom frontends and the d6e instance — how they relate](https://github.com/d6e-ai/d6e-custom-frontend-skills/blob/main/docs/frontend-and-instance.md) ([日本語版](https://github.com/d6e-ai/d6e-custom-frontend-skills/blob/main/docs/frontend-and-instance.ja.md)) — where the prompt rules and workspace this skill assumes actually live, and how they can be provisioned by a Plugin.
