...
| Prompts, schemas, parsers, render | `scripts/prompts/*.md`, `src/lib/journal-schema.ts`, `src/lib/parse-journal.ts`, `src/lib/components/{journal,registration}-result.svelte` | `d6e-prompt-driven-ui`     |
